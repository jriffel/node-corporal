...
module.exports.getAutocompleteArguments = function(currentCommand, currentLine, callback) {
    ...
    var lastArg = fullCommandParsed.args[fullCommandParsed.args.length - 1];
    ...
    var filtered = _filterAutocompleteArguments(fullCommandParsed.args);
    return callback(false, filtered.map(function(a) { return a.str; }));
};
...
module.exports.getAutocompleteReplacements = function(currentCommand, currentLine, replacementsArray, callback) {
    ...
    replacementsArray = replacementsArray.map(function(replacement) {
